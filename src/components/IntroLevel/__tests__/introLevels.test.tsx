...
import introLevels from "../introLevels";

describe("list of intro levels", () => {
  it("matches certain list", () => {
    expect(introLevels).toEqual([
      {
      ...
      },
      {
        hint: (
          <span>
            it is also recommended to find a very dark place <Typist.Delay ms={700} /> and exercise
            in evenings
          </span>
        ),
      },
